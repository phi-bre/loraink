...
//SPIClass s(HSPI); // VSPI or HSPI
GxIO_Class io(SPI, /*CS=5*/ 23, /*DC=*/ 13, /*RST=*/ 12); // arbitrary selection of 17, 16
GxEPD_Class display(io, /*RST=*/ 12, /*BUSY=*/ 17); // arbitrary selection of (16), 4
